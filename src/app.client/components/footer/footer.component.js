  ...
  return (
    <footer className={props.estilos}>
      ...
      >
        ...
        >
          <g style={{ transform: "translate(0.13229166px,0.13229166px)" }}>
            <path
              className={"bordeAnim " + props.pathStyle}
      ...
      >
        ...
        >
          <g style={{ transform: "translate(0.07157455px,0.13229166px)" }}>
            <path
              className={"bordeAnim " + props.pathStyle}
...
export default Radium(FooterApp);
