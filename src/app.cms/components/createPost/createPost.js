...
const mapDispachToProps = dispatch => {
  return {
    ...
    onAddElement: payload => dispatch({type: 'ADD_ELEMENT', payload: payload}),
    onEditElement: payload =>
      dispatch({type: 'EDIT_ELEMENT', payload: payload}),
    onDelElement: payload => dispatch({type: 'DEL_ELEMENT', payload: payload}),
    ...
    onDateProgram: date => dispatch({type: 'SET_PROGRAM_DATE', payload: date}),
    onDatePublish: date => dispatch({type: 'PUBLISH_POST_DATE', payload: date}),
    onSave: () => dispatch({type: 'SAVE_POST'}),
    onProjectChange: () => dispatch({type: 'CHANGE_PROJECT'}),
    onMenuChange: payload => dispatch({type: 'CHANGE_MENU', payload: payload}),
...
export default withRouter(
  connect(mapStateToProps, mapDispachToProps)(CreatePost)
)
