...
<p style="font-size: 18px; line-height: 21px; margin: 0;">You have changed your email address. This communication is for you to verify your new address, so please <a href="${webURL}/api/emailVerification?id=${code}" rel="noopener" style="text-decoration: underline; color: #0068A5;" target="_blank">Click Here</a> or the link below for confirm your new email address:</p>
