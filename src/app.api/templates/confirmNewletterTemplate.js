...
<p style="font-size: 18px; line-height: 21px; margin: 0;">Hello <span class="username"><strong>${name}</strong></span>,</p>
<p style="font-size: 18px; line-height: 21px; margin: 0;"> </p>
<p style="font-size: 18px; line-height: 21px; margin: 0;">You have subscribe to our newsletter. So please <a href="${webURL}/api/emailNewsVerification?id=${id}" rel="noopener" style="text-decoration: underline; color: #0068A5;" target="_blank">Click Here</a> or the link below for confirm your email address:</p>
<p style="font-size: 18px; line-height: 21px; margin: 0;"><br/>

<a href="${webURL}/api/emailNewsVerification?id=${id}" rel="noopener" style="text-decoration: underline; color: #0068A5;" target="_blank">https://www.swordvoice.com/api/emailNewsVerification?id=${id}</a>
...
<div style="color:#555555;font-family:'Work Sans';line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
<div style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 14px; line-height: 16px; color: #555555;">
<p style="font-size: 18px; line-height: 16px; text-align: left; margin: 0;"><span style="font-size: 14px;">We’ve sent you this email because you or someone in your behalf used your email address for subscribe to our newsletter; if you do not approve this action, skip this communication.</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif"><![endif]-->
